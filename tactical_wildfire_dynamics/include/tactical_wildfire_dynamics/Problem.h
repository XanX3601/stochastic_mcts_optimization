...
class TWD::Problem {
    ...
    public:
        ...
        int cell_to_index(const TWD::Cell& cell) const;
        TWD::Cell index_to_cell(int cell_index) const;

        int get_grid_width() const;
        int get_grid_height() const;
        int get_cell_count() const;
        int get_cell_initial_fuel_amount(const TWD::Cell& cell) const;
        int get_cell_initial_fuel_amount(int cell_index) const;
        bool is_cell_initially_burning(const TWD::Cell& cell) const;
        bool is_cell_initially_burning(int cell_index) const;
        double get_probability_that_y_ignites_x(const TWD::Cell& x, const TWD::Cell& y) const;
        double get_probability_that_y_ignites_x(int x_index, int y_index) const;
        double get_probability_to_extinguish_cell(const TWD::Cell& cell) const;
        double get_probability_to_extinguish_cell(int cell_index) const;
        int get_cell_burning_reward(const TWD::Cell& cell) const;
        int get_cell_burning_reward(int cell_index) const;
        int get_team_count() const;

        unsigned long long get_cell_fuel_random_bitstring(const TWD::Cell& cell, int fuel_amount) const;
        unsigned long long get_cell_fuel_random_bitstring(int cell_index, int fuel_amount) const;
        unsigned long long get_cell_burning_random_bitstring(const TWD::Cell& cell, bool is_cell_burning) const;
        unsigned long long get_cell_burning_random_bitstring(int cell_index, bool is_cell_burning) const;
        unsigned long long get_cell_team_random_bitstring(const TWD::Cell& cell, int team_index) const;
