...
class twm::Problem {
   ...
   public:
    ...
    Problem(int grid_width, int grid_height, const std::vector<int>& each_cell_initial_fuel_amount,
    ...
    bool is_in_grid(const Cell& cell) const;
    ...
    unsigned long long get_cell_burning_random_bitstring(const twm::Cell& cell,
                                                         bool is_cell_burning) const;
    unsigned long long get_cell_burning_random_bitstring(int cell_index,
                                                         bool is_cell_burning) const;
